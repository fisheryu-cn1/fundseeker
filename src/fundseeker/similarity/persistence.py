...
def save_cluster_run(
    ...
    Args:
        ...
        baseline_run_id: For incremental runs, the full run this run is based on.
    ...
    with Session() as session:
        ...
        # Runs that are referenced as baselines by other runs must be preserved
        # to keep the foreign-key relationship intact.
        referenced_ids = {
            row[0]
